...
class LlmResponseParser:
    ...
    def AgentLoop(
        ...
        return typing.cast(typing.Union["types.BashTool", "types.GlobTool", "types.GrepTool", "types.LSTool", "types.ExitPlanModeTool", "types.ReadTool", "types.WebFetchTool", "types.TodoReadTool", "types.TodoWriteTool", "types.WebSearchTool", "types.EditTool", "types.MultiEditTool", "types.WriteTool", "types.NotebookEditTool", "types.AgentTool", "types.ReplyToUser"], result)
    ...
    def SubAgentLoop(
        ...
        return typing.cast(typing.Union["types.BashTool", "types.GlobTool", "types.GrepTool", "types.LSTool", "types.ExitPlanModeTool", "types.ReadTool", "types.WebFetchTool", "types.TodoReadTool", "types.TodoWriteTool", "types.WebSearchTool", "types.EditTool", "types.MultiEditTool", "types.WriteTool", "types.NotebookEditTool", "types.ReplyToUser"], result)
...
class LlmStreamParser:
    ...
    def SubAgentLoop(
        self, llm_response: str, baml_options: BamlCallOptions = {},
    ) -> typing.Union["stream_types.BashTool", "stream_types.GlobTool", "stream_types.GrepTool", "stream_types.LSTool", "stream_types.ExitPlanModeTool", "stream_types.ReadTool", "stream_types.WebFetchTool", "stream_types.TodoReadTool", "stream_types.TodoWriteTool", "stream_types.WebSearchTool", "stream_types.EditTool", "stream_types.MultiEditTool", "stream_types.WriteTool", "stream_types.NotebookEditTool", "stream_types.ReplyToUser"]:
        ...
        return typing.cast(typing.Union["stream_types.BashTool", "stream_types.GlobTool", "stream_types.GrepTool", "stream_types.LSTool", "stream_types.ExitPlanModeTool", "stream_types.ReadTool", "stream_types.WebFetchTool", "stream_types.TodoReadTool", "stream_types.TodoWriteTool", "stream_types.WebSearchTool", "stream_types.EditTool", "stream_types.MultiEditTool", "stream_types.WriteTool", "stream_types.NotebookEditTool", "stream_types.ReplyToUser"], result)
